...
const data = {
  ...
  "Sensors - Light": [
    "LDR", "Photodiode", "Phototransistor", "BH1750", "TSL2561", "Ambient light sensor"
  ],
  "Sensors - Motion": [
  ...
  "Protection Components": [
    "Fuse", "Resettable fuse", "TVS diode", "Zener diode", "MOV", "ESD protection diode", "Reverse-polarity protection", "Over-current protection", "Over-voltage protection", "Thermal fuse", "Heat sink", "Thermal pad", "Cooling fan"
  ],
  "Connectors & Mechanical Parts": [
    "DC jack", "AC plug", "Terminal block", "JST connector", "Molex connector", "Dupont connector", "Header pins", "PCB screw terminal", "Alligator clips", "Crocodile clips", "Wires", "Jumper wires", "Ribbon cable", "Heat-shrink tubing", "Cable ties", "Screws", "Nuts", "Bolts", "Spacers", "Standoffs", "Project enclosure", "Plastic box", "Acrylic sheet"
  ],
  ...
  "IoT / Smart Project Components": [
    "Wi-Fi module", "Bluetooth module", "GSM module", "GPS module", "LoRa module", "MQTT-compatible controller", "ESP8266", "ESP32", "ESP32-CAM", "Raspberry Pi", "Cloud/loT gateway", "SD-card module", "MicroSD card", "Ethernet module", "Camera module", "OLED display", "Relay module", "Smart energy meter module"
  ],
  "Camera & Vision": [
    "OV7670 camera", "OV2640 camera", "ESP32-CAM", "Raspberry Pi camera", "USB webcam", "IR camera module", "Camera lens", "IR LED array"
  ],
  "Industrial / Advanced B.Tech Components": [
    "PLC", "HMI", "VFD", "Industrial relay", "Contactor", "Current transformer", "Proximity switch", "Inductive proximity sensor", "Capacitive proximity sensor", "Photoelectric sensor", "Industrial temperature sensor", "RTD", "PT100", "Thermocouple", "Pressure transmitter", "Flow sensor", "Level sensor", "Solenoid valve", "Pneumatic solenoid", "Industrial encoder"
  ],
...
const run = async () => {
  try {
    await connectDB();
    console.log('Connected to DB. Removing existing fake data...');
    ...
    console.log('Processing import of current data...');
...
module.exports = { importMassiveData: run };
